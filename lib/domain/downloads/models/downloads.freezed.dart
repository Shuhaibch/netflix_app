...
class _$_Downloads implements _Downloads {
  ...
  @override
  String toString() {
    return 'Downloads(posterPath: $posterPath, title: $title, backdropPath: $backdropPath, id: $id)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, posterPath, title, backdropPath, id);
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
      ...
      @JsonKey(name: "id") required final int? id}) = _$_Downloads;
